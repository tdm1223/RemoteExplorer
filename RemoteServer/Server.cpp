...
void CompressSockets(SOCKET sockArray[], int idx, int total);
void CompressEvents(WSAEVENT eventArray[], int idx, int total);
...
int main()
{
    ...
    if (WSAEventSelect(serverSock, newEvent, FD_ACCEPT) == SOCKET_ERROR)
    {
